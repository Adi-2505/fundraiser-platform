	...
	return (
		<div>
			<div className="flex items-center">
				...
				<button
					type="submit"
					className="inline-flex items-center p-2 ms-2 text-sm font-medium text-white bg-blue-700 rounded-sm border border-blue-700 hover:bg-blue-800  focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700 "
